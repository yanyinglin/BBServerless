...
def main(scal):
    ...
    configuration_linear = {
        ...
        "estimators": [
            ...
            {
                "name": "randomforestregressor-{}".format(scal),
...
def train_models(configuration):
    ...
    for estimator_conf in configuration["estimators"]:
        ...
        with open(
            "../Runtimes/ml-inference-with-data-RT/models/{}".format(name), "wb"
        ) as model:
            pickle.dump(estimator_conf["instance"], model)

        with open(
            "../Runtimes/ml-inference-with-data-RT/testData/{}".format(name), "wb"
        ) as test_data:
